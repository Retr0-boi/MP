<div class="container-second-analytics">
  ...
  ?>
      <div class="graph-class">
        ...
        $query = "SELECT date, weight FROM logged_weights WHERE uid='$SID' AND ex_id='$ex_id' ORDER BY date DESC";
    ...
    <ul>
      <li style='list-style-type: none;'>Uh oh we didn't find any logged analytics for exercises on <?php echo $d_full; ?></li>
    </ul>
  <?php }
  ?>
</div>