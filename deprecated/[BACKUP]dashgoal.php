...
<div class="section bottom">
  ...
  ?>
        ...
        ?>
            <div class="goal-list">
              ...
              <div class="goal-buttons">
                <button type="submit" class="square-button-complete-goal" name="completed_<?php echo $goal_id; ?>">
                  <i class="fa-solid fa-circle-check" style="color: #25a825;"></i>
                </button>
                <button type="submit" class="square-button-delete-goal" name="deleted_<?php echo $goal_id; ?>">
    ...
    <?php
    if (isset($_POST['completed_' . $goal_id])) {
      echo "<li>$goal_id pressed </li>";
      ...
      if (!$result->num_rows > 0) {
        echo "<li>No matching record found in 'goals' table for goal_id $goal_id</li>";
      } else {
    ...
    if (isset($_POST['deleted_' . $goal_id])) {
      $goal_id = $_POST['ip_goal_id']; // Get the goal_id from the hidden input
