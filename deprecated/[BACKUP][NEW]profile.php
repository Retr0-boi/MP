    ...
    <div class="profile-container">
        ...
        <div class="container-profile">
            <div class="section top">
                ...
                <?php else : ?>
                    ...
                    <div class="form-item">
                        <input type="text" id="newUsername" name="newUsername" placeholder="Change Username"readonly>
                    </div>
                    <div class="form-item">
                        <input type="email" id="newEmail" name="newEmail" placeholder="Change Email"readonly>
                    </div>
                    <div class="form-item">
                        <input type="password" id="newPassword" name="newPassword" placeholder="Change Password" readonly>
                    </div>
                    
                    <button type="submit" onclick="demo()">Update Profile</button>
                </form>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="container-profile">
            <div class="section top">
                        ...
                        if (isset($_POST['delete_all'])) { ?>
                            <div class="deletoin_confirmation">
                                ...
                                if (isset($_POST['act_delete_all'])) {
                                    ...
                                    if (
                                        $conn->query($del_data_bodyweight) &&
                ...
                <?php else : ?>
                    <form class="Delete_profile">
                        <button class="delete_button"  onclick="demo()">Delete all logged data</button>
                        
                        <br>
                        <button class="delete_button" onclick="demo()">Delete account</button>
